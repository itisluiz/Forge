...
export class UserApiService {
	...
	public signup(userSignupRequest: UserSignupRequest): Observable<UserSigninResponse> {
		return this.apiService.call<UserSigninResponse, UserSignupRequest>(
			"POST",
			"user/signup",
			undefined,
			userSignupRequest,
		).pipe(tap((userSigninResponse) => { this.setTokenFromSigninResponse(userSigninResponse) }));
	}

	public signin(userSigninRequest: UserSigninRequest): Observable<UserSigninResponse> {
		return this.apiService.call<UserSigninResponse, UserSigninRequest>(
			"POST",
			"user/signin",
			undefined,
			userSigninRequest,
